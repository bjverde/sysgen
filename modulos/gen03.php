...
if( $_SESSION[APLICATIVO][TableInfo::TP_SYSTEM] != TGeneratorHelper::TP_SYSTEM_REST ){
    ...
    $frm->addHtmlField('info', null, 'ajuda/info_gen03_type_rest_pt-br.php')->setClass('htmlInfo', true);
}
...
$frm->addButton(Message::GEN03_BTN_NEXT4_LABEL, Message::GEN03_BTN_NEXT4_ACT, 'Gerar', null, null, false, false);
...
switch ($acao) {
    ...
    case 'clean':
        ...
        break;
    //--------------------------------------------------------------------------------
    case Message::GEN03_BTN_NEXT4_ACT:
        if ($frm->validate()) {
            try {
